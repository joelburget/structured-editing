...
var _user$project$Ast$tranform = _elm_lang$core$Native_Platform.incomingPort('tranform', _elm_lang$core$Json_Decode$string);

var Elm = {};
Elm['Ast'] = Elm['Ast'] || {};
_elm_lang$core$Native_Platform.addPublicModule(Elm['Ast'], 'Ast', typeof _user$project$Ast$main === 'undefined' ? null : _user$project$Ast$main);
